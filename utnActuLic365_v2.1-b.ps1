...
$REPO_URL = "https://github.com/ricardomonla/UTN-ActuLIC365/raw/refs/heads/main/utnActuLic365_v2.1-b.ps1" # **IMPORTANT: Update this if the script name changes in the repo!**
$SCRIPT_NAME = "utnActuLic365_v2.1-b.ps1"
